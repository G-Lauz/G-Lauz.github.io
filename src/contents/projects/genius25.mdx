...
thumbnail: ../assets/vector_field.png
thumbnailAlt: The vector field of the score function of a gaussian distribution.
---
...
<Figure src="/videos/highlight_sauce.mp4" alt="Sauce Pour Task" media="video" controls autoplay loop playsinline muted preload="metadata">
